...
class CustomizedBusDataset(Dataset):
    ...
    def __getitem__(self, idx):
        return (self.static[idx], self.dynamic1[idx], self.dynamic2[idx], self.dynamic3[idx], self.static[idx, :, 0:1], self.problem_record1[idx], self.problem_record2[idx], self.problem_record3[idx])
